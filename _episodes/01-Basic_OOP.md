...
- They are not meant to be called directly by the user (neither interally or externally), but rather are used by Python when something is required from a class or their instances.
